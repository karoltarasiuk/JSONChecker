...
var JSONNodeFactory = {
    ...
    /**
     * Detects the type of the node from passed JSON, and creates an instance of it.
     *
     * @param  {[JSON]} json
...
_.extend(JSONNode.prototype, {
    ...
    check: function () {
        ...
        // one single rule
        } else if (_.isObject(this.specification)) {



        // specification must be either array or object
        } else {
            throw "Wrong format of specification provided: " + this.context;
        }
    }
});
...
var JSONNodeInteger = function () {};

_.extend(JSONNodeInteger.prototype, JSONNode.prototype, {});
